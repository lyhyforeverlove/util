...
//        log.debug(" ===============> url:" + url + " param:" + paramMap.size());
        ...
        try {
            ...
            System.err.println("httppost--->>" + httppost.toString());
...
//                    throw new HttpResponseException(statusLine.getStatusCode(), statusLine.getReasonPhrase());
    ...
    public static String httpPostRequestXml(String url, String xml) throws IOException {
//      log.debug(" ===============> url:" + url + " param:" + paramMap.size());
      HttpClient httpclient = null;
      try {
          httpclient = new DefaultHttpClient(new ThreadSafeClientConnManager());
...
//        httppost.addHeader(new BasicHeader("Content-Type", "application/x-www-form-urlencoded"));
          ...
          AbstractHttpEntity entity = new StringEntity(xml, Consts.UTF_8);
